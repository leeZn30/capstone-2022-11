...
/** Sets the role of the user in interactive live streaming.
 ...
 or [didClientRoleChangeFailed]([AgoraRtcChannelDelegate rtcChannel:didClientRoleChangeFailed:currentRole:]) on the local client in 5s.
...
/** Starts pushing media streams to a CDN without transcoding.
 ...
 After you call this method, the SDK triggers the [rtmpStreamingChangedToState]([AgoraRtcChannelDelegate rtcChannel:rtmpStreamingChangedToState:state:errorCode:]) callback on the local client to report the state of the streaming.
 ...
 **Note:**
 ...
 - If you want to retry pushing streams after a failed push, make sure to call [stopRtmpStream]([AgoraRtcChannel stopRtmpStream:]) first, then call this method to retry pushing streams;
 otherwise, the SDK returns the same error code as the last failed push.
 - If you want to push media streams in the RTMPS protocol to CDN,
 call [startRtmpStreamWithTranscoding]([AgoraRtcChannel startRtmpStreamWithTranscoding:transcoding:]) instead of [startRtmpStreamWithoutTranscoding]([AgoraRtcChannel startRtmpStreamWithoutTranscoding:]).
...
/** Updates the transcoding configuration.
 ...
 The SDK triggers the [rtcChannelTranscodingUpdated]([AgoraRtcChannelDelegate rtcChannelTranscodingUpdated:]) callback after the transcoding configuration is updated.
...
/** Creates a data stream.
 ...
 @param[out] streamId ID of the created data stream.
...
The SDK triggers this callback when the local user switches the user role failed by calling the [setClientRole]([AgoraRtcChannel setClientRole:]) method after joining the channel.

 @param rtcChannel  AgoraRtcChannel object.
 @param reason  The reason of changing client role failed. See details in `AgoraRoleChangeFailedReason`.
 @param currentRole  Current Role that the user holds: AgoraClientRole.
 */
...
The SDK triggers this callback when the local user switches the user role succeed by calling the [setClientRole]([AgoraRtcChannel setClientRole:]) method after joining the channel.

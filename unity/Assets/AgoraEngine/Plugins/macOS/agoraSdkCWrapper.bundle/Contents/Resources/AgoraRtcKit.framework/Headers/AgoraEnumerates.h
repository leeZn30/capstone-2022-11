...
/** The video denoiser mode parameter. */
typedef NS_ENUM(NSUInteger, AgoraVideoDenoiserMode) {
  /** Default mode, turn off denoiser automatically based on the env brightness. */
  AgoraVideoDenoiserModeAuto = 0,
  /** Manual mode, on/off denoiser manually. */
  AgoraVideoDenoiserModeManual = 1,
};

/** The denoiser level. */
typedef NS_ENUM(NSUInteger, AgoraVideoDenoiserLevel) {
  /** process the denoiser with the high quality. */
  AgoraVideoDenoiserLevelHighQuality = 0,
  /** process the denoiser with fast mode. */
  AgoraVideoDenoiserLevelFast = 1,
  /** process the denoiser with the strength */
  AgoraVideoDenoiserLevelStrength = 2,

};

/** The lowlight enhancement mode. */
...
/** The volume type of audio device test report. */
typedef NS_ENUM(NSInteger, AgoraAudioDeviceTestVolumeType) {
  /** 0 audio device test recording volume
   **/
  AgoraAudioDeviceTestRecordingVolume = 0,
  /** 1 audio device test playback volume
   */
  AgoraAudioDeviceTestPlaybackVolume = 1,
} NS_SWIFT_NAME(AgoraAudioDeviceTestVolumeType);

...
The default value is 0.6. The value ranges from 0.0 (original) to 1.0.
 */
...
The default value is 0.3. The value ranges from 0.0 (original) to 1.0. This parameter is used to improve the sharpness level/clarity of the pic.
*/
@property(nonatomic, assign) float sharpnessLevel;

@end

/** The video denoiser options in [setVideoDenoiserOptions]([AgoraRtcEngineKit setVideoDenoiserOptions:options:]). */
...
/** The lowlight enhance options in [setLowlightEnhanceOptions]([AgoraRtcEngineKit setLowlightEnhanceOptions:options:]). */
...
/** The color enhance options in [setColorEnhanceOptions]([AgoraRtcEngineKit setColorEnhanceOptions:options:]). */
__attribute__((visibility("default"))) @interface AgoraColorEnhanceOptions : NSObject

/** Color enhance strength. The value ranges between 0 (default) and 1.*/
@property(nonatomic, assign) float strengthLevel;

/** Skin protect level. The value ranges between 0 (default) and 1.*/

...
The SDK triggers this callback when the local user switches the user role failed by calling the [setClientRole]([AgoraRtcEngineKit setClientRole:]) method after joining the channel.

 @param engine  AgoraRtcEngineKit object.
 @param reason  The reason of changing client role failed. See details in `AgoraClientRoleChangeFailedReason`.
...
/** Reports the volume of audio device test.
 @param engine AgoraRtcEngineKit object.
 @param volumeType the type of volume: recording = 0, playback = 1.
 @param volume the volume of recording test or playback test.
 */
...
/** Sets the role of the user in interactive live streaming.
 ...
 or [didClientRoleChangeFailed]([AgoraRtcEngineDelegate rtcEngine:didClientRoleChangeFailed:currentRole:]) on the local client in 5s.
 ...
 **Note:**
 ...
 call [startRtmpStreamWithTranscoding]([AgoraRtcEngineKit startRtmpStreamWithTranscoding:transcoding:]) instead of [startRtmpStreamWithoutTranscoding]([AgoraRtcEngineKit startRtmpStreamWithTranscoding:transcoding:]).
...
* < 0: Failure.
 */
- (int)addVideoWatermark:(AgoraImage* _Nonnull)watermark __deprecated_msg("use addVideoWatermark:url options instead.");
